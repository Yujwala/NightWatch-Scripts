...
module.exports = {
  '@tags': ['download-shelf-desktop','desktop','download-shelf'],
    //Opening the URL
    "Opening the Desktop URL": function(client) {
            globalProps(client);
            client.maximizeWindow();    
            callback.openURL(client,pageurl.LOM_DOWNLOAD_SHELF);
            console.log("--Desktop--"+pageurl.LOM_DOWNLOAD_SHELF); 
    },
    ...
    "1 Check for download wrapper properities": function(client) {
            ...
            client.elements('css selector',downloadshelfCls,results=>{
               if(results.value.length>0) {
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downloadshelfProps('lg');  
            ...
            client.elements('css selector',downloadshelfcontainerCls,results=>{
               if(results.value.length>0) {
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downloadshelfcontainerProps('lg');  
            ...
            client.elements('css selector',headergroupCls,results=>{
               if(results.value.length>0) {
                console.log("entered 3");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.headergroupProps('lg');  
            ...
            client.elements('css selector',headersignpostCls,results=>{
               if(results.value.length>0) {
                console.log("entered 4");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.headersignpostProps('lg');  
              ...
              client.elements('css selector',headerheadlineCls,results=>{
               if(results.value.length>0) {
                console.log("entered 5");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.headerheadlineProps('lg');  
       ...
       client.elements('css selector',downloadgriditemsCls,results=>{
               if(results.value.length>0) {
                console.log("entered 6");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downloadgriditemsProps('lg');  
        ...
        client.elements('css selector',griditemsleftCls,results=>{
               if(results.value.length>0) {
                console.log("entered 7");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.griditemsleftProps('lg');  
        ...
        client.elements('css selector',downloadtextleftCls,results=>{
               if(results.value.length>0) {
                console.log("entered 8");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downloadtextleftProps('lg');  
        ...
        client.elements('css selector',downloadtextrightCls,results=>{
               if(results.value.length>0) {
                console.log("entered 9");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downloadtextrightProps('lg');  
         ...
         client.elements('css selector',downlaodiconCls,results=>{
               if(results.value.length>0) {
                console.log("entered 10");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downlaodiconProps('lg');  
          ...
          client.elements('css selector',downlaodiconrightCls,results=>{
               if(results.value.length>0) {
                console.log("entered 11");
                 ...
                 //shelf bg color
                 properties = download_shelf_props.downlaodiconrightProps('lg');  
