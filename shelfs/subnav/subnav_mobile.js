...
module.exports = {
    '@tags': ['subnav-mobile', 'subnav','mobile'],
    //Opening the URL
    ...
    "Opening the Mobile URL": function(client) {
           globalProps(client);
           callback.openURL(client,pageurl.NW_BUS_SUBNAV_MOB);
           console.log("--Mobile--"+pageurl.NW_BUS_SUBNAV_MOB);  
    },
        ...
        if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            client.elements('css selector',subnavShelf,results=>{
                if(results.value.length>0) { 
                    ...
                    Properties = subnav_props.subnavShelfPropssm('lg');  
                    callback.singleElem(client,subnavShelf, Properties, 'lg');
                    Properties = subnav_props.subnavShelfInnerPropssm('lg');  
        ...
        if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            client.elements('css selector',headerGroup,results=>{
                if(results.value.length>0) { 
                    ...
                    //Headline
                    Properties = subnav_props.headlinePropssm('lg');  
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        client.elements('css selector',subnav2FirstChild,results=>{
            if(results.value.length>0) { 
                ...
                Properties = subnav_props.subnav2ChevronPropsMob('lg');  
                callback.multiloop(client,subnav2Chevron, Properties, 'lg');
                //Subnav with 2 children Padlock Props                 
                Properties = subnav_props.subnav2PadlockPropsMob('lg');  
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        client.elements('css selector',subnav3FirstChild,results=>{
            if(results.value.length>0) { 
                ...
                Properties = subnav_props.subnav3FirstChildAnchorPropsMob('lg');  
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        client.elements('css selector',subnav4FirstChild,results=>{
            if(results.value.length>0) { 
                ...
                Properties = subnav_props.subnav4FirstChildAnchorPropsMob('lg');  
...
"7. Checking reward SUBNAV grid(with 4 children) props ": function(client) {
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        client.elements('css selector',rewardsubnav4FirstChild,results=>{
            if(results.value.length>0) { 
                //Subnav with 4 children (First Child)                  
                Properties = subnav_props.rewardsubnav4FirstChildPropsMob('lg');  
                callback.multiloop(client,rewardsubnav4FirstChild, Properties, 'lg');
                //Subnav with 4 children (First Child) Anchor 
                Properties = subnav_props.rewardsubnav4FirstChildAnchorPropsMob('lg');  
                callback.multiloop(client,rewardsubnav4FirstChildAnchor, Properties, 'lg');
                //Subnav with 4 children (Second Child)                  
                Properties = subnav_props.rewardsubnav4SecondChildPropsMob('lg');  
                ...
                //Subnav with 4 children (Third Child)                  
                Properties = subnav_props.rewardsubnav4ThirdChildPropsMob('lg');  
                ...
                //Subnav with 4 children (Last Child)
                Properties = subnav_props.rewardsubnav4LastChildPropsMob('lg');  
                ...
                //Subnav with 4 children Heading Text Props                 
                Properties = subnav_props.rewardsubnav4InsideHeadingTextPropsMob('lg');  
                callback.multiloop(client,rewardsubnav4InsideHeadingText, Properties, 'lg');
                //Subnav with 4 children Chevron Props                 
                Properties = subnav_props.subnav3ChevronPropsMob('lg');  
                callback.multiloop(client,rewardsubnav4Chevron, Properties, 'lg');
                //Subnav with 4 children Padlock Props                 
                Properties = subnav_props.subnav3PadlockPropsMob('lg');  
                callback.multiloop(client,rewardsubnav4Padlock, Properties, 'lg');
            }
        });
    }      
 },
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        client.elements('css selector',subnav5FirstChild,results=>{
            if(results.value.length>0) { 
                ...
                Properties = subnav_props.subnav5FirstChildAnchorPropsMob('lg');  
                ...
                Properties = subnav_props.subnav5InsideHeadingTextPropsMob('lg');  
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        client.elements('css selector',subnav6FirstChild,results=>{
            if(results.value.length>0) { 
                ...
                Properties = subnav_props.subnav6FirstChildAnchorPropsMob('lg');  
...
//                         }
//                         else if(num==6 && brand.props.$brandName=='ulster'||num==6 && brand.props.$brandName=='ulster-ie'||num==5 && brand.props.$brandName=='ulster-ie'){
//                             Properties = subnav_props["subnavGridsPropssm6"]('lg');                      
//                             callback.singleElem(client,nextElem, Properties,'lg');          

//                         }
//                         else{
//                         Properties = subnav_props["subnavGridsPropssm"]('lg');                      
//                         callback.singleElem(client,nextElem, Properties,'lg');                     
...
//                         }
//                         else if(brand.props.$brandName=='rbs-personal'){
...
//                         var num = results.value.length.toString();
//                         if(num==3){                            
//                             Properties = subnav_props.subnavLinkProps3Gridssm('lg');
//                             callback.singleElem(client,LinknextElem, Properties,'lg');                        
//                         }
//                         else{                    
                        
//                         Properties = subnav_props.subnavLinkPropssm('lg');
//                         callback.singleElem(client,LinknextElem, Properties,'lg');
//                          }
                        
//                         Properties = subnav_props["subnavLinkPropssm"+num]('lg');
//                         callback.singleElem(client,LinknextElem, Properties,'lg');
...
//                         Properties = subnav_props["subnavHeadPropssm"]('lg');
//                         callback.singleElem(client,HeadnextElem, Properties,'lg');

//                     //subnav Head Inner properties
//                         Properties = subnav_props['subnavHeadInnerPropssm']('lg');
...
//                         Properties = subnav_props['subnavChevronPropssm']('lg');
//                         callback.singleElem(client,subnavChevron, Properties,'lg');
//                         Properties = subnav_props["subnavChevronPropssm"+num]('lg');
//                         callback.singleElem(client,subnavChevron, Properties,'lg');
...
//                         var num = results.value.length.toString(); 
//                         if(i==1){                            
//                             Properties =subnav_props['firstChildBgcolorPropssm'+num]('lg'); 
//                             callback.singleElem(client,nextElem, Properties,'lg');
//                         }
...
//                         Properties =subnav_props["subnavMob"+num+"GridBgclr"+i]('lg');  
//                         callback.singleElem(client,nextElem, Properties,'lg');
//                         }
//                     }                    
//                 });
...
//                         Properties = subnav_props.subnvGridHoverPropssm('lg');  
        ...
        if(results.value.length>0) {               
            client.elements('css selector',subnavhover,results=>{                              
                for(var i=0; i<results.value.length; i++){                               
                    ...
                    Properties = subnav_props.subnavGridonHover('lg');  
                    callback.singleElem(client,subnavGridonHover, Properties, 'lg');
                    Properties = subnav_props.subnvGridHoverPropsMob('lg');  
                    callback.singleElem(client,newHover, Properties, 'lg');                  
        ...
        if(results.value.length>0) {               
            client.elements('css selector',subnav3hover,results=>{                              
                for(var i=0; i<results.value.length; i++){                               
                    ...
                    Properties = subnav_props.subnv3GridHoverPropsMob('lg');  
    ...
    "7. Checking SUBNAV RTE props ": function(client) {
        ...
        client.elements('css selector',subnavDescription,results=>{
            if(results.value.length>0) {
                client.elements('css selector',subnavDescription,results=>{
                    if(results.value.length>0) {
                        Properties = subnav_props.subnavRTEPropssm('lg');  
                        callback.multiloop(client,subnavRTE, Properties, 'lg'); 

                        Properties = subnav_props. subnavRTEStrongPropssm('lg');  
                        callback.multiloop(client,subnavRTEStrong, Properties, 'lg');
                        
                        Properties = subnav_props. subnavRTELinkPropssm('lg');  
            ...
            client.elements('css selector',subnavGrid,results=>{
                if(results.value.length>0) {           
                    client.elements('css selector',subnavGridItemCount,results=>{                      
                            ...
                            Properties = subnav_props.subnvGridFocusPropsMob('lg');
