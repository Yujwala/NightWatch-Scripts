var pageurl = require('../../pageurls.js'),
    pageObj,hero_carousel_props,callback,size,brand;

function globalProps(client){
    pageObj = client.page.hero_carousel_selectors(),
    callback = client.page.common(),
    size = client.globals.size.widths; 
    callback.getBrand(client);
    var brandFile = client.globals.brand;
    brand = require('../../branding/'+brandFile);
    hero_carousel_props = require('./hero_carousel_props.js')(client);  
}

module.exports = {
  '@tags': ['desktop', 'hero-carousel', 'hero-carousel-desktop'],
    //Opening the URL
    "Opening the Desktop URL": function(client) {
            globalProps(client);
            client.maximizeWindow();    
            callback.openURL(client,pageurl.RBS_COM_HERO_CAROUSEL);
            client.pause(3000);
    },
    ...
    "1 Check for slider wrap properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.sliderWrapProps('lg');  
    ...
    "2 Check for slider image properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.sliderImgProps('lg');  
    ...
    "3 Check for slider content properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.sliderContentProps('lg');  
    ...
    "4 Check for slider content heading properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.sliderContentHeadingProps('lg');  
    ...
    "5 Check for slider content rte properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.sliderContentRteProps('lg');  
            callback.multiloop(client, sliderContentRte , properties, 'lg');

            properties = hero_carousel_props.sliderContentRteTextProps('lg');  
    ...
    "6 Check for CTA properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.sliderContentCtaProps('lg');  
            callback.multiloop(client, sliderContentCta , properties, 'lg');

           //cta hover
            properties = hero_carousel_props.sliderContentCtaHoverProps('lg');
            ...
            //client.waitForElementVisible(sliderContentCta, 7000);
            client.moveToElement(sliderContentCta,  10,  10);
            client.mouseButtonDown(0);
            client.pause(1000);
            properties = hero_carousel_props.sliderContentCtaMouseDownProps('lg');
            callback.singleElem(client, sliderContentCta , properties, 'lg');
    ...
    "7 Check for flex prev arrow properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.flexPrevArrowProps('lg');  
            ...
            client.mouseButtonDown(0);
            client.pause(5000);
            properties = hero_carousel_props.flexPrevArrowMouseDownProps('lg');
    ...
    "8 Check for flex next arrow properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            properties = hero_carousel_props.flexNextArrowProps('lg');  
          ...
          // client.expect.element(flexNextArrow).to.have.attribute('src')
           client.pause(2000);
    ...
    "9 Check for flex control nav properties": function(client) {
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            client.mouseButtonDown(0);
            client.pause(1000);
            properties = hero_carousel_props.flexNavLiAnchorMouseDownProps('lg');
    ...
    "11 Check for CTA links properties": function(client) {
      sliderContentLinkCta = pageObj.elements.sliderContentLinkCta.selector;
      globalProps(client);

    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){

      properties = hero_carousel_props.sliderContentLinkCtaProps('lg');  
      callback.multiloop(client, sliderContentLinkCta , properties, 'lg');

     //cta hover
      properties = hero_carousel_props.sliderContentLinkCtaHoverProps('lg');
      client.moveToElement(sliderContentLinkCta, 10, 10);
      client.pause(10000);
      callback.singleElem(client, sliderContentLinkCta, properties, 'lg');   

      //sec cta mouse down props
      //client.waitForElementVisible(sliderContentLinkCta, 7000);
      client.moveToElement(sliderContentLinkCta,  10,  10);
      client.mouseButtonDown(0);
      client.pause(1000);
      properties = hero_carousel_props.sliderContentLinkCtaMouseDownProps('lg');
      callback.singleElem(client, sliderContentLinkCta , properties, 'lg');

      //Check if anchor tags have href attribute
     client.verify.attributeContains('.cta--mapp-l:not(.cta--l):not(.cta--m) a', 'href', '/');
