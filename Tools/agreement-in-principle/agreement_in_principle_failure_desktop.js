...
module.exports = {
  '@tags': ['desktop', 'agreement-in-principle', 'agreement-in-principle-desktop'],
    ...
    "Opening the Desktop URL": function(client) {
            ...
            callback.openURL(client,pageurl.NW_PERSONAL_AIP_DESKTOP); 
    ...
    "2. Checks for Page 2 Properties": function(client) {
            ...
            fnameField1= pageObj.elements.fnameField1.selector,
            lnameField1= pageObj.elements.lnameField1.selector,
            dob1= pageObj.elements.dob1.selector,
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            client.click(fnameField1);
            client.setValue(fnameField1, "a");
            client.pause(1000)
            ...
            client.clearValue(fnameField1)            
            client.setValue(fnameField1, property.$fnameField);
            client.expect.element(fnameField1).to.have.css('background-image').which.contains(property.$tick_url);
             //Enter the Last Name - Error Message
             client.click(lnameField1);
             client.setValue(lnameField1, "b");
             client.pause(1000)
             client.click(".js-mortgage-form.js-show-content")
             client.expect.element(".tool--mortgageDetails.tool--aip div.error-container-bottom").text.to.contain("Please enter a minimum of 2 and maximum of 30 characters")
             //Enter the First Name
             client.clearValue(lnameField1)             
            //Enter the Last Name
            client.setValue(lnameField1, property.$lnameField);
            client.expect.element(lnameField1).to.have.css('background-image').which.contains(property.$tick_url);
            
            //Enter the Date of Birth
            client.click(dob1)
            client.setValue(dob1, "010101")
            client.pause(1000)
            client.click(".js-mortgage-form.js-show-content")
            ...
            client.expect.element(dob1).to.have.css('background-image').which.contains(property.$error_url);
            client.clearValue(dob1)
            client.setValue(dob1, property.$dob );
            client.expect.element(dob1).to.have.css('background-image').which.contains(property.$tick_url);
    ...
    "3. Checks for Page 3 Properties": function(client) {
            ...
            callToAction1= pageObj.elements.callToAction1.selector,
            address1= pageObj.elements.address1.selector,
            addBtn= pageObj.elements.addBtn.selector,
            postcode= pageObj.elements.postcode.selector,
            houseno1= pageObj.elements.houseno1.selector,
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            client.click(address1);
            client.setValue(address1,"")
            client.pause(1000)
            ...
            client.clearValue(address1)
            client.setValue(address1, property.$address);
            client.expect.element(address1).to.have.css('background-image').which.contains(property.$tick_url);
            ...
            client.click(houseno1)
            client.clearValue(houseno1)
            client.setValue(houseno1, "")
            ...
            client.clearValue(houseno1)
            client.setValue(houseno1, property.$houseno);
            client.expect.element(houseno1).to.have.css('background-image').which.contains(property.$tick_url);
    ...
    "4. Checks for Page 4 Properties": function(client) {
            ...
            callToAction1= pageObj.elements.callToAction1.selector,
            income1= pageObj.elements.income1.selector,
            otherIncome1= pageObj.elements.otherIncome1.selector,
            onebox1= pageObj.elements.onebox1.selector,
            twobox1= pageObj.elements.twobox1.selector,
            threebox1= pageObj.elements.threebox1.selector,
          ...
          if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
            ...
            client.click('select[id="agreementPrinciple_retirement-age"] option[value="68"]')
            //Enter the Gross income
            client.click(income1);
            client.setValue(income1, property.$income);
            client.expect.element(income1).to.have.css('background-image').which.contains(property.$tick_url);
            
            //Enter the Term for Gross Income
            client.click('select[id="agreementPrinciple_term"] option[value="monthly"]')
            client.pause(1000)
            //Enter the Other Income
            client.click(otherIncome1);
            client.setValue(otherIncome1, property.$otherIncome);
            client.expect.element(otherIncome1).to.have.css('background-image').which.contains(property.$tick_url);

            //Enter the Amount Left
            client.click(onebox1);
            client.setValue(onebox1, property.$onebox);
            client.expect.element(onebox1).to.have.css('background-image').which.contains(property.$tick_url);

            //Enter Monthly Debt Repayment
            client.click(twobox1)
            client.setValue(twobox1, property.$twobox);
            client.expect.element(twobox1).to.have.css('background-image').which.contains(property.$tick_url);

            //Enter Other Commited Expenditures
            client.click(threebox1)
            client.setValue(threebox1, property.$threebox);
            client.expect.element(threebox1).to.have.css('background-image').which.contains(property.$tick_url);
            //Call to Action Focus 
            client.moveToElement(".itl-tool-enhancements .q-nav .next span a",3,3);
            client.mouseButtonDown(".itl-tool-enhancements .q-nav .next span a");
            client.pause(1000);
    ...
    "5. Checks for Page 5 Properties": function(client) {
      ...
      propertyValue1= pageObj.elements.propertyValue.selector,
      yourDeposit1= pageObj.elements.yourDeposit.selector,
    ...
    if(client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice){
        ...
        client.click(propertyValue1);
        client.setValue(propertyValue1, property.$propertyValue1);
        client.expect.element(propertyValue1).to.have.css('background-image').which.contains(property.$tick_url);

        //Enter the Deposit
        client.click(yourDeposit1);
        client.setValue(yourDeposit1, property.$yourDeposit);
        client.expect.element(yourDeposit1).to.have.css('background-image').which.contains(property.$tick_url);

        //Enter Term for Mortgage
        client.click('select[name="mortgage-term"] option[value="4"]')
        client.pause(1000)
