...
module.exports = {
    '@tags': ['desktop', 'supplier-lookup', 'supplier-lookup-desktop'],
    " 1 Opening the Desktop URL": function(client) {
        globalProps(client);
        client.maximizeWindow();
        callback.openURL(client,pageurl.RBS_PER_SUPPLIERLOOKUP);
        console.log("--Desktop--" + pageurl.RBS_PER_SUPPLIERLOOKUP);
    },
    "2.Checking for header properties": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            //Header Properties
            properties = supplier_lookup_props.headerbanner('lg');
            callback.multiloop(client, headerbanner, properties, 'lg');
            //Header Properties
            properties = supplier_lookup_props.bannertitle('lg');
            callback.multiloop(client, bannertitle, properties, 'lg');
            //Header Properties
            properties = supplier_lookup_props.bannerdes('lg');
    ...
    "3. Checking the properties of middle wrapper": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            //Header Properties
            properties = supplier_lookup_props.midcontentwrap('lg');
    ...
    "4. Checking the properties of search section": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            //Search section
            properties = supplier_lookup_props.searchsection('lg');
            callback.multiloop(client, searchsection, properties, 'lg');
            //Search Title
            properties = supplier_lookup_props.searchtitle('lg');
            callback.multiloop(client, searchtitle, properties, 'lg');
            // Search description
            properties = supplier_lookup_props.searchdes('lg');
            callback.multiloop(client, searchdes, properties, 'lg');
            // Search Box
            properties = supplier_lookup_props.searchbox('lg');
            callback.multiloop(client, searchbox, properties, 'lg');
            // Search Icon
            properties = supplier_lookup_props.searchicon('lg');
    ...
    "5. Checking the properties of major suppliers section": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            ...
            properties = supplier_lookup_props.majorsuppliers('lg');
    ...
    "6. Checking the for focus of major supplier UL ": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            ...
            client.pause(2000);
            properties = supplier_lookup_props.supplierulfocus('lg');
    ...
    "7. Checking the properties of list items": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            //List items
            properties = supplier_lookup_props.listTitles('lg');
            callback.multiloop(client, listTitles, properties, 'lg');
            properties = supplier_lookup_props.listItems('lg');
    ...
    "8. Checking the properties of Conditions section": function(client) {
        ...
        if (client.globals.test_settings.isLocal || client.options.desiredCapabilities.isLGDevice || client.options.desiredCapabilities.isSMDevice) {
            //List items
            properties = supplier_lookup_props.conditionsSec('lg');
            callback.multiloop(client, conditionsSec, properties, 'lg');
            properties = supplier_lookup_props.firstrte('lg');
            callback.multiloop(client, firstrte, properties, 'lg');
            properties = supplier_lookup_props.secondrte('lg');
