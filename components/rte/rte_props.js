...
PropTextTable1Tr1: function(size) {
    let shelfProps = {
        "background-color":"rgba(207, 199, 190, 1)"
     };
 return shelfProps;
},
PropTextTable1Tr2: function(size) {
    let shelfProps = {
        "background-color":"rgba(233, 229, 224, 1)"
     };
 return shelfProps;
},
PropTextTable1Th: function(size) {
    let shelfProps = {
         "line-height": "12px",
         "font-size":"12px",
         "padding":"17.4px 3.6px 17.4px 5px",
         "font-family":"RNHouseSansBold",
     };
 return shelfProps;
},
PropTextTable1Td: function(size) {
    let shelfProps = {
         "line-height": "13px",
         "font-size":"13px",
         "padding":"18.85px 3.9px 18.85px 5px",
         "font-family":property.$font_family_regular,
     };
 return shelfProps;
},
PropTextTable2Th: function(size) {
    let shelfProps = {
         "line-height": "36px",
         "font-size":"18px",
         "padding":"0px 9px",
...
PropTextTable2Td: function(size) {
    let shelfProps = {
         "line-height": "18px",
         "font-size":"18px",
         "padding":"19.35px",
